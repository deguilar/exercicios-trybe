...
const valorProdutoComImposto = custoProduto * 1.2;
let lucro = 0;

console.log('Valor do produto com imposto embutido: R$ ' + valorProdutoComImposto);

if (custoProduto < 0 || valorDeVenda < 0) {
    console.log('Erro! Valor passado, menor que R$ 0,00');
} else {
    lucro = (valorDeVenda - valorProdutoComImposto) * 1000;
}
